...
class PrimaryAccess extends Component {
    state = { 
        topic: this.props.topic
     } 
    render() { 
        return (
            <div className='d-flex px-5 pt-4 justify-content-between'>
                <h4 className='col-2 px-2 access-topic-primary'>{this.state.topic}</h4>
